CLASS zcl_generate_travel_data_rgo DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_GENERATE_TRAVEL_DATA_RGO IMPLEMENTATION.


  METHOD if_oo_adt_classrun~main.

    DATA itab TYPE TABLE OF ztravel_rgo.
...
*   delete existing entries in the database table
    DELETE FROM ztravel_rgo.

*   insert the new table entries
    INSERT ztravel_rgo FROM TABLE @itab.
